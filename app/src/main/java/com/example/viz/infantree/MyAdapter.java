...
import com.example.viz.infantree.Home.SpannableAdapter;
...
//    private int mIcons[];
    ...
    MyAdapter(int rowLayout, Context context, String name, String age, int profile) {
//        mNavTitles = TITLES;
//        mIcons = ICONS;
...
//                rowImage = (ImageView) itemView.findViewById(R.id.rowIcon);
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // 뷰의 타입이 헤더일 때
            ...
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.header, viewGroup, false); // 마찬가지
