...
public class SeeDiaryActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String convertedDate = currentDiaryDate.replace('/', '-'); // "2015-05-15"
        ...
        // db에서 데이터 가져오기
        c.moveToFirst();
        final String photoId = c.getString(c.getColumnIndex(InfantreeContract.Diaries.PHOTO_ID));
        String momDiary = c.getString(c.getColumnIndex(InfantreeContract.Diaries.MOM_DIARY));
        String dadDiary = c.getString(c.getColumnIndex(InfantreeContract.Diaries.DAD_DIARY));
        ...
        if (photoId != null) {
            ...
            if (!imageFilePath.exists()) {
                ...
                Thread tt = new Thread() {
                    ...
                    public void run() {
                        super.run();
                        new ImageDownloadHelper(SeeDiaryActivity.this).downloadImageFile(photoId);
                    }
