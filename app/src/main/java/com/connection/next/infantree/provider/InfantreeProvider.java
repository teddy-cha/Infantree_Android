...
public class InfantreeProvider extends ContentProvider {
    ...
    static {
        ...
        URI_MATCHER.addURI(InfantreeContract.AUTHORITY, "Photos", PHOTO_LIST);
        URI_MATCHER.addURI(InfantreeContract.AUTHORITY, "Photos/#", PHOTO_ID);
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case PHOTO_LIST:
                if (TextUtils.isEmpty(sortOrder)) {
                    sortOrder = InfantreeContract.Photos.SORT_ORDER_DEFAULT;
                }
                whichTable = PHOTO_TABLE_NAME;
                whichProjection = InfantreeContract.Photos.PROJECTION_ALL;
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (URI_MATCHER.match(uri)) {
            case PHOTO_LIST:
                resultId = database.insertWithOnConflict(PHOTO_TABLE_NAME, null, values, SQLiteDatabase.CONFLICT_REPLACE);
