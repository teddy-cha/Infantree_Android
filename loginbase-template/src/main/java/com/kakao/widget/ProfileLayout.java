 ...
 * </br>
 * 1. 프로필을 노출할 layout에 {@link com.kakao.widget.ProfileLayout}을 선언한다.
 * </br>
 * 2. {@link com.kakao.widget.ProfileLayout#setEditable(boolean)}를 이용하여 사용자가 프로필 수정 가능한 페이지인지 설정한다. 기본값은 수정되지 않는 것이다.
 * </br>
 * 3. {@link com.kakao.widget.ProfileLayout#setMeResponseCallback(com.kakao.MeResponseCallback)}를 이용하여 사용자정보 요청 결과에 따른 callback을 설정한다.
 * </br>
 * @author MJ
 */
